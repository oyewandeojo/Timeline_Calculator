...
st.markdown(
    f"<span style='background-color:{gray}; padding:5px; font-style:italic;'> Against a set cut-off date (in this case when assay results are returned and invoiced).<br>
